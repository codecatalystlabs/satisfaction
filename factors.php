        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: var(--bs-navbar-brand-hover-color);">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-7 col-xl-8 col-xxl-8" style="width: 1140px;">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Factors contributing to 80% of client dissatisfaction</h6>
                                ...
                                <div class="card-body">
                                    <div class="chart-area"><canvas id="dissatisfactionChart"></canvas></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    fetch('php/contrib.php') // Change to your actual PHP path
            ...
            new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Factors Contributing to 80% of Client Dissatisfaction'
                        }
                    },
                    scales: {
                        x: {
